...
export default function NovaOrdemInternaPage() {
  ...
  function podeAvançar(): boolean {
    if (step === 1) return !!data_producao && !!solicitado_por
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                  ...
                  <div className="space-y-4 mb-6 pb-6 border-b border-gray-200">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        <p className="text-gray-500">Data de Produção</p>
                        <p className="font-semibold text-gray-800">{new Date(data_producao + 'T00:00:00').toLocaleDateString('pt-BR')}</p>
                      </div>
                      <div>
