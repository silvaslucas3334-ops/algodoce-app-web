  ...
  return (
    <div className="p-4">
      <div className="flex items-center justify-between pt-4 mb-4">
        <h1 className="text-xl font-bold text-gray-800">Minhas Ordens</h1>
        {podecriarOrdens && (
          <Link href="/ordens/nova" className="bg-pink-700 text-white rounded-lg px-3 py-1.5 text-sm flex items-center gap-1 hover:bg-pink-800">
            <Plus size={16} /> Nova
          </Link>
        )}
      </div>
