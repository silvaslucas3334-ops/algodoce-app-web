...
export default function ReceberRomaneioPage() {
  ...
  async function confirmarRecebimento() {
    ...
    try {
      // Extrair IDs das etiquetas (lotes) do romaneio
      ...
      // Atualizar status dos lotes para 'na_loja'
      ...
      // Atualizar status do romaneio para em_estoque (recebido pela loja)
      ...
      alert('✓ Romaneio recebido com sucesso!')
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Confirmar Recebimento</h1>
            <p className="text-sm text-gray-600">
              Romaneio de {new Date(romaneio.data_entrega + 'T00:00:00').toLocaleDateString('pt-BR')}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-700">
              <strong>Status atual:</strong> Confirmado pela Cozinha
            </p>
          </div>
